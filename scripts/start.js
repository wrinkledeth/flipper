...
async function main() {
  ...
  let bit = await flipper.get();
  console.log("Bit Value Retrieved:", bit)

  bit = await flipper.connect(somebodyElse).get();
  console.log("Bit Value Retrieved as somebody else:", bit);
